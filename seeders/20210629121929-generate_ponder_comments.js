...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('pondercomments', [
      ...
      {id: 5, userId: 1, ponderId: 3, content: 'Este es mío?', createdAt: new Date(), updatedAt: new Date()},
      {id: 6, userId: 1, ponderId: 2, content: 'Lorem ipsum', createdAt: new Date(), updatedAt: new Date()},
      {id: 7, userId: 2, ponderId: 4, content: 'Para probar eliminar', createdAt: new Date(), updatedAt: new Date()},
    ], {});
  },
